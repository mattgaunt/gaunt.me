---
title: Creating a Theme With Nuxt 3
published: August 08, 2022
---

# {{ $doc.title }}

Nuxt 3 is fast approaching a stable release, seven months following the first release candidate and it's becoming better with each edition.

Having used Nuxt 3 for multiple personal projects over the last few months, I figured it was worth sharing what I've been doing with it, and some of the neat tricks I've found a long the way.

### First up, Nuxt themes!

I expect this to be documented sooner or later, but having followed the initial RFC issue, I'd been keeping a close eye on its progress, and following its release into RC11, I figured I'd jump in and take a look.



## Getting Started

First up, let's spin up a new Nuxt application, using the standard setup as found on the docs.
